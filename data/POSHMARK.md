...
```bash
python3 scripts/map-poshmark-psv.py data/poshmark-batch-1.psv data/poshmark-batch-2.psv data/poshmark-import.json
```
...
Later batches (3–5) should append to the same JSON using the same mapper. Do not invent photos or prices.
